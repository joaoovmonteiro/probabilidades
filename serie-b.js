// Gerenciador de dados da Série B
class SerieBManager {
    static async loadData() {
        try {
            ...
            const proximosJogosData = await DataLoader.loadJSON('data/proximos_jogos_serie_b.json');
            ...
            console.log('Série B carregada com sucesso!');
            
        } catch (error) {
            console.error('Erro ao carregar dados da Série B:', error);
            this.showError('Erro ao carregar dados da Série B. Tente recarregar a página.');
        }
    }
